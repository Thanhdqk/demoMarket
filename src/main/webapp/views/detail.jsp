			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="single-product-content">
						<h3>${product.tensp}</h3>
						<p class="single-product-pricing"><span>${product.soluong}</span><h4><strong>Price: <fmt:formatNumber type="number" maxFractionDigits="3" value="${product.giasp}" /></strong></h4></p>
						...
						<div class="single-product-form">
							...
							<button class="btn cart-btn" type="button" id="addToCart"><i class="fas fa-shopping-cart"></i>Add to cart</button>
