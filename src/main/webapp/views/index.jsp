...
<body>
	...
	<div class="product-section mt-150 mb-150">
		<div class="container">
					...
					<div class="product-filters">    
						<ul>
							<c:forEach var="category" items="${listCategory}">
								<li ><a class="danhmuc" href="<c:url value='/sanpham?maDM=${category.madm}'/>">${category.tendanhmuc}</a></li>
							</c:forEach>
						</ul>
					</div>
				</div>
			...
			<div class="row">		
				<ul class="thumbnails listing-products" style="display: flex; flex-wrap: wrap;">
					<c:forEach var="product" items="${listProduct}">
						<li class="product-box" style="flex: 0 0 calc(31% - 20px); margin-right: 20px;">
							<div>
								<span class="sale_tag"></span>                                                
								<a href="<c:url value='/sanpham?maSP=${product.masp}' />"><img class="product-image" alt="" src="<c:url value='home/themes/images/product/${product.hinh}' />"></a><br/>
								<a style="font-weight: bolder;" href="<c:url value='/sanpham?maSP=${product.masp}' />" class="title">${product.tensp}</a><br/>
								<p class="product-price">
									<fmt:formatNumber type="number" maxFractionDigits="3" value="${product.giasp}" /><p>VNĐ</p>
								</p>
							</div>
						</li>
					</c:forEach>       
